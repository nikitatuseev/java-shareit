...
class BookingControllerTest {
    ...
    void create() throws Exception {
        ...
        CreateBookingDto creationBookingDto = CreateBookingDto.builder()
                .itemId(1)
    ...
    @Test
    void confirmStatusBookingIdLessThenZero() throws Exception {
        int userId = 1;
        int bookingId = -1;
    ...
    @Test
    void getByIdBookingIdLessThanZero() throws Exception {
        int bookingId = -1;
        int userId = -1;
